...
def model_fn(inference_weights):
	...
	model = Efficient(model_name='efficientnet-b5', weights=inference_weights, input_shape=(3, 456, 456), num_classes=1000)
...
model = model_fn(r'./models/zoo/efficient-b5-ns.pth')
model = model.cuda()
